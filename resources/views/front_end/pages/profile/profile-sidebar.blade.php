<div class="profile-side">
    <div class="profile-sec">
        <div class="user-img">
            <div class="update_img_user">
                <div class="update_img_user_img">
                    <img src="{{(!empty(Auth::user()->image)) ? asset(Auth::user()->image) : asset('assets/img/dummy.jpg') }}"
                        alt="dp">
                </div>
        ...
        <div class="edit_option_bar">
            ...
            <div class="content-bar">
                <a href="{{ route('profile.change.password') }}" class="tabedit">Mettre à jour le mot de passe</a>
            </div>
        </div>
    </div>
</div>
